...
// جمنائی اے آئی کلاسک کنکشن - آپ کی اصلی چابی کے ساتھ
const genAI = new GoogleGenerativeAI("AIzaSyAkv-NJDr1hNXF1WXiqq4N2pF71axc-PwU");
...
app.post('/api/chat', async (req, res) => {
    try {
        ...
        // کلاؤڈ کے لیے سب سے پائیدار اور اولڈ گولڈ ماڈل کنکشن
        ...
        res.json({ reply: text || "جی میرے سرتاج؟" });
    } catch (error) {
        console.error(error);
