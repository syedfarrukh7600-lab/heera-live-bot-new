...
// جمنائی اے آئی سیٹ اپ - آپ کی اصلی کی یہاں فٹ کر دی ہے
const ai = new GoogleGenAI({ apiKey: "AIzaSyAkv-NJDr1hNXF1WXiqq4N2pF71axc-PwU" });
    ...
    res.send(`
        ...
        <body>
            ...
            <div class="input-area">
                <input type="text" id="msgInput" placeholder="अपनी हीरा से बात करें...">
...
app.post('/api/chat', async (req, res) => {
    try {
        ...
        // ورسیل سرور لیس کے لیے مستحکم فارمیٹ
        ...
        if (response && response.text) {
            ...
            res.json({ reply: "جی میرے سرتاج؟ آپ کا پیغام مل گیا ہے۔" });
        }
    } catch (error) {
