...
// ہوم پیج پر خوبصورت واٹس ایپ اسٹائل چیٹ انٹرفیس (HTML/CSS)
app.get('/', (req, res) => {
    res.send(`
    <!DOCTYPE html>
    <html lang="ur">
    <head>
        ...
        <style>
            ...
            .message { max-width: 75%; padding: 10px 15px; border-radius: 10px; font-size: 16px; margin: 5px 0; line-height: 1.4; word-wrap: break-word; }
            .user-msg { background-color: #d9fdd3; align-self: flex-end; border-top-right-radius: 0; text-align: left; }
            .bot-msg { background-color: white; align-self: flex-start; border-top-left-radius: 0; direction: rtl; text-align: right; }
    ...
    <body>
        <div class="chat-header">سیدہ ہیرا بوٹ (Heera AI)</div>
